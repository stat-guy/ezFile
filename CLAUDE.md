...
Supported states: PA, NY, CA, CT, NJ, IL, WI, MA, RI, ME, IN, CO, AZ, UT, MI, OH, KY, VA, HI, WV, NC, SC, GA, VT, MD, DE, AL, MS, MN, IA, MO, AR, LA, ND, NE, KS, OK, MT, NM, ID, OR, DC, and territories PR, USVI; plus all no-income-tax states (AK, FL, NV, NH, SD, TN, TX, WA, WY). State reference files are at `reference/states/<st>.md`.
